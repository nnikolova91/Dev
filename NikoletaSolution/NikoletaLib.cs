...
{
    public class NikoletaLib
    {
        /// <summary>
        /// Fix Emails  Uprajneniq   Zada4a    4
        /// </summary>
        static void Re4niciZada4a4()
        {
            ...
            do
            {
                ...
                if ((mail[mail.Length - 1] != 's' && mail[mail.Length - 2] != 'u') || (mail[mail.Length - 1] != 'k' && mail[mail.Length - 2] != 'u'))
                {
                    dicc[ime] = mail;
                }
        ...
        /// <summary>
        /// A Miner Task  Uprajneniq  Zada4a    3
        /// </summary>
        static void Re4niciiiiiZad3()
        {
            ...
            do
            {
                ...
                int stoinost = int.Parse(Console.ReadLine());

                if (dic.ContainsKey(vhod))
                {
                    dic[vhod] += stoinost;
                }
                else
        ...
        /// <summary>
        /// Phonebook Upgrade  Zada4a 2
        /// </summary>
        static void Re4niciZad2()
        {
            var phonBook = new SortedDictionary<string, string>();
            bool krai = false;
            do
            {
                var kontakt = Console.ReadLine()
                ...
                if (kontakt[0] == "A")
                {
                    phonBook[kontakt[1]] = kontakt[2];
                }
                else if (kontakt[0] == "S")
                {
                    if (phonBook.ContainsKey(kontakt[1]))
                    {
                        string tel = phonBook[kontakt[1]];

                        Console.WriteLine("{0} -> {1}", kontakt[1], tel);

                    }
                    else
                    {
                        Console.WriteLine("Contact {0} does not exist.", kontakt[1]);
                    }
                }
                else if (kontakt[0] == "ListAll")
                {
                    // phonBook.Keys.OrderBy(k => k);
                    foreach (var phon in phonBook)
                    {
                        Console.WriteLine(String.Join(" ", phon.Key, phon.Value));
                    }
                }
                else if (kontakt[0] == "END")
                {
                    krai = true;
                }
        ...
        /// Phone book  Zada4a          1
        /// </summary>
        static void Re4niciUprZad1()
        {
            var phonBook = new Dictionary<string, string>();
            bool krai = false;
            do
            {
                var kontakt = Console.ReadLine()
        ...
        /// <summary>
        /// Razdeli i suberi   Zada4a    5
        /// </summary>
        static void Re4niciZad5()
        {
            ...
            arr1.AddRange(arr.Take(k).Reverse());
            arr1.AddRange(arr.Skip(3 * k).Take(k).Reverse());

            List<int> arr2 = new List<int>();
            arr2.AddRange(arr.Skip(k).Take(2 * k));
        ...
        /// <summary>
        /// Nai-golemite tri 4isla Zada4a   4
        /// </summary>
        static void Re4niciZad4()
        {
            List<int> chisla = Console.ReadLine()
                .Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries)
                .Select(int.Parse)
                .ToList();
            List<int> naiGolemi = new List<int>(chisla);
            naiGolemi.OrderByDescending(x => x).Take(3);

            Console.WriteLine(String.Join(" ", naiGolemi.OrderByDescending(x => x).Take(3)));
        }

        /// <summary>
        /// Sum, min,Max, Average   Zada4a   3
        /// </summary>
        static void Re4niciZad3()
        {
        ...
        /// <summary>
        /// Broi na realni 4isla vuv vuzhodq6t red   Zada4a 1
        /// </summary>
        static void Re4niciUabZad1()
        {
            double[] input = Console.ReadLine()
                .Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries)
                .Select(double.Parse)
                .ToArray();
            var broi = new Dictionary<double, int>();

            foreach (var inp in input)
            {
                if (broi.ContainsKey(inp))
                {
                    broi[inp]++;
                }
                else
            ...
            var sort = new SortedDictionary<double, int>(broi);
            foreach (var sor in sort)
            {
                Console.WriteLine("{0} -> {1}", sor.Key, sor.Value);
            }
        }
        /// <summary>
        /// Strani na kvadrat  Zada4a 6
        /// </summary>
        static void ListsZad6()
        {
            List<int> chisla = Console.ReadLine()
                .Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries)
                .Select(int.Parse)
            ...
            {
                if (Math.Sqrt(chisla[i]) == (int)Math.Sqrt(chisla[i]))
                {
                    sort.Add(chisla[i]);
                }
        ...
        /// <summary>
        /// Sortirane po vuzhodq6t red Zad   5
        /// </summary>
        static void ListsZad5()
        {
            List<int> chisla = Console.ReadLine()
                .Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries)
                .Select(int.Parse)
        ...
        /// <summary>
        /// Algoritum za namirane na nai-dulga i nai-lqva  GRE6EN
        /// </summary>
        static void SpisuciSortirane()
        {
            ...
            List<int> poSpisuk = new List<int>();
            List<int> maximalenSpisuk = new List<int>();
            ...
            for (int i = 0; i <= arr.Length - 1; i++)
            {
                ...
                {
                    for (int r = spisuk.Count - 1; r >= 1; r--)
                    {


                        if (spisuk[r - 1] >= spisuk[r])
                        {
                            spisuk.RemoveAt(r);
                            r = spisuk.Count;
                        }
                ...
                if (spisuk.Count > poSpisuk.Count /*&& purvo<naiPurvo */)
                {
                    poSpisuk = new List<int>(spisuk);
                }

                else if (spisuk.Count == poSpisuk.Count)
                {
                    bool izlez = false;
                    int indexR = 0;
                    for (int k = 0; k <= spisuk.Count - 1; k++)
                    {
                        if (spisuk[k] == poSpisuk[k])
                        {
                            for (int r = indexR; r <= arr.Length - 1; r++)
                            {
                                if (spisuk[k] == arr[r] && poSpisuk[k] == arr[r])
                                {
                                    indexR = r + 1;
                                    break;
                                }
            ...
            Console.WriteLine(String.Join(" ", poSpisuk));
        }

        /// <summary>
        /// Kolko puti se povtarq edno 4islo
        /// </summary>
        static void Re4niciPovtarq6ti4isla()
        {
        ...
        /// 
        /// </summary>
        static void Re4nikDati()
        {
            //var events = new SortedDictionary<DataTime, string>();
            //events[new DataTime(2017, 2, 18)] = "Zdravo se naporkah";
            //events[new DataTime(1998, 9, 4)] = "Googls's birth date";
            //events[new DataTime(2013, 11, 5)] = "SoftUni's birth date";
            //events[new DataTime(1975, 4, 4)] = "Microsoft's birth date";
            //events[new DataTime(2004, 2, 4)] = "Facebook's birth date";
        ...
        /// <summary>
        /// Unikalni dumi, ne4eten broi Lab
        /// </summary>
        static void Re4niciDumi()
        {
